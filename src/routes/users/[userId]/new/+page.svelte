...
<div class="flex flex-row p-10 h-screen">
	<div class="w-[65%] rounded-xl bg-slate-300 p-8 shadow-xl shadow-slate-900">
		<form use:enhance method="post" action="?/new">
			<h1 class="font-bold text-2xl text-center text-slate-600">Create Assessment Template</h1>
			...
			<input
				...
				class="my-2 w-full rounded-md border p-2 focus:border-blue-300 focus:outline-none focus:ring"
			/>
			...
			<select class="select w-full rounded-md border border-gray-300 p-2 my-2" name="type" placeholder="Select type here...">
			...
			<input
				...
				class="w-full my-2 rounded-md border border-gray-300 p-2 focus:border-blue-300 focus:outline-none focus:ring"
			/>
			...
			<div class="flex justify-end p-2">
				<button
					type="submit"
					class="mx-auto mt-12 flex h-14 w-52 items-center rounded-xl bg-cyan-700 p-4 text-center text-lg text-white hover:bg-slate-800 hover:text-white"
					>Add Form / Edit Form</button
				>
			</div>
		</form>
	</div>
	<div class="ml-5 w-[35%] rounded-xl bg-slate-300 shadow-xl shadow-slate-900">
		<ul class="h-full rounded-lg p-1 shadow-md">
			<!-- <tbody class="p-3"> -->
			{#each assessments as a}
				<a href="new/{a.id}/question"
					><li class="m-2 mt-5 h-20 rounded-lg border-2 border-slate-500 bg-slate-400 text-center shadow-xl shadow-slate-500">
